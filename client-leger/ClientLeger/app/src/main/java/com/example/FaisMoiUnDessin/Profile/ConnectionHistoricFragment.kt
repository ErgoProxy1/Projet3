 ...
 * Use the [ConnectionHistoricFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class ConnectionHistoricFragment : Fragment() {
    // TODO: Rename and change types of parameters

    private var connectionList: List<String> = List(0){""}
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.fragment_connection_historic, container, false)
    }
    ...
    fun setConnections(){
        connectionList = ProfileHolder.formattedTimeListConnect
        if(isLoaded){
            updateVisuals()
        }
    }
    ...
    private fun updateVisuals() {
        val layout = requireView().findViewById<LinearLayout>(R.id.connectLayout)
